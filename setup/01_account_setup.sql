...
CREATE SCHEMA IF NOT EXISTS CINDER_ANALYTICS.INTERMEDIATE
    COMMENT = 'Conformed dimension unions assembled from fragments across events';
...
GRANT ALL ON SCHEMA CINDER_ANALYTICS.INTERMEDIATE TO ROLE CINDER_DBT_PROD_ROLE;
